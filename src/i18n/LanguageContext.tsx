...
export const translations: Record<Language, Translations> = {
  EN: {
    ...
    product: {
      ...
      walletMethodSub: 'Exact payment of 29.00 USDT via Web3 Wallet (BNB Smart Chain).',
      manualMethodSub: 'Transfer with unique control decimals for automatic verification without connecting wallet.',
      buyNowWallet: 'Get Commercial Kit — 29 USDT',
    ...
    paid: {
      ...
      downloadProduct: 'Download Commercial Kit',
    ...
    whyUs: {
      ...
      valueSectionBadge: 'POR QUÉ VALE MÁS DE $29 USDT / VALUE STACK',
      valueSectionHeading: 'Why VOLT Paywall is Worth 10x More Than $29 USDT',
    ...
    faq: {
      ...
      q4: 'What exactly is included in my $29 USDT purchase?',
  ...
  ES: {
    ...
    product: {
      ...
      walletMethodSub: 'Transferencia exacta de 29.00 USDT vía Web3 Wallet (BNB Smart Chain).',
      manualMethodSub: 'Transferencia con decimales de control únicos para verificación automática sin conectar wallet.',
      buyNowWallet: 'Obtener Kit Comercial — 29 USDT',
    ...
    paid: {
      ...
      downloadProduct: 'Descargar Kit Comercial',
    ...
    whyUs: {
      ...
      valueSectionHeading: 'Por qué VOLT Paywall vale 10 veces más que $29 USDT',
    ...
    faq: {
      ...
      q4: '¿Qué incluye mi pago de $29 USDT?',
