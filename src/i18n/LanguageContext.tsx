...
export const translations: Record<Language, Translations> = {
  EN: {
    ...
    hero: {
      ...
      ctaPrimary: 'Buy Commercial Kit — 29 USDT',
    ...
    product: {
      ...
      title: 'VOLT Paywall Commercial Kit',
      tagline: 'Self-Hosted USDT BEP-20 Checkout (0% Intermediary Fees)',
      description: 'Complete editable source code + Cloudflare Worker backend + No-Code embed generator + Telegram alerts + unlimited commercial license + setup docs. Instant digital delivery upon on-chain confirmation.',
      feature1: 'Source Worker + Frontend (React 18 + Vite + Tailwind + Cloudflare Worker)',
      feature2: 'Visual generator for iframe embeds & direct payment links',
      ...
      buyNowWallet: 'Buy Commercial Kit — 29 USDT',
    ...
    faq: {
      ...
      subheading: 'Clear answers on our VOLT Paywall Commercial Kit, delivery formats, and BSC USDT settlement',
      q1: 'What is VOLT Paywall Commercial Kit and what is included?',
      a1: 'VOLT Paywall Commercial Kit (29 USDT) is a complete, self-hosted crypto checkout solution for digital products and source code. You receive full editable source code (React + Vite + Tailwind + Cloudflare Worker backend), embed generator for WordPress/Webflow, automated BSC verification engine, anti-replay ledger, Telegram alerts, and an unlimited commercial license with 0% platform fees.',
      ...
      q4: 'What is Vibe Error Fixer?',
      a4: 'Vibe Error Fixer (9 USDT) is a separate developer utility from the VOLT ecosystem for diagnosing and debugging build logs and stack traces in AI-generated code. It is sold here as an optional developer credit pack (5 analyses) and accessed on its own dedicated tool page.',
  ...
  ES: {
    ...
    product: {
      ...
      description: 'Código fuente editable + Cloudflare Worker backend + generador de embeds No-Code + alertas a Telegram + licencia comercial ilimitada + documentación paso a paso. Entrega digital inmediata tras confirmación on-chain.',
      feature1: 'Código Worker + Frontend editable (React 18 + Vite + Tailwind + Cloudflare Worker)',
      feature2: 'Generador visual de embeds Iframe y enlaces de pago directos',
      ...
      buyNowWallet: 'Comprar Commercial Kit — 29 USDT',
    ...
    faq: {
      ...
      subheading: 'Respuestas claras sobre el VOLT Paywall Commercial Kit, formatos de entrega y cobro en USDT BSC',
      q1: '¿Qué es VOLT Paywall Commercial Kit y qué incluye?',
      a1: 'VOLT Paywall Commercial Kit (29 USDT) es una solución completa y auto-alojada de pasarela crypto para venta de productos digitales y código fuente. Incluye código fuente 100% editable (React + Vite + Tailwind + Cloudflare Worker backend), generador de embeds No-Code para WordPress/Webflow, motor de verificación automática en BSC, libro mayor anti-replay, alertas de Telegram y licencia comercial ilimitada con 0% de comisiones de plataforma.',
      q2: '¿Por qué el pago se realiza strictly en USDT en BNB Smart Chain (BEP-20)?',
      ...
      q4: '¿Qué es Vibe Error Fixer?',
      a4: 'Vibe Error Fixer (9 USDT) es una herramienta de utilidad independiente del ecosistema VOLT para el diagnóstico y depuración asistida por IA de logs de error y trazados de pila en código generado por IA. Se ofrece aquí como un paquete opcional de 5 créditos de análisis y se utiliza en su propia aplicación web.',
