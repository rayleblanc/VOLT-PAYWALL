...
import { ChevronDown, HelpCircle, ShieldCheck, Cloud, DollarSign, Cpu, RefreshCw, Download, Send } from 'lucide-react';
...
export const FAQ: React.FC = () => {
  ...
  return (
    <section id="faq" className="w-full py-10 sm:py-16 bg-[#080808] border-t border-white/5" aria-label="Frequently Asked Questions">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        {/* FAQ Header */}
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-300 text-xs font-bold uppercase tracking-wider font-mono">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-white">
                {isEs ? '¿Tienes alguna duda técnica antes de ordenar?' : 'Have any technical questions before purchasing?'}
              </h3>
